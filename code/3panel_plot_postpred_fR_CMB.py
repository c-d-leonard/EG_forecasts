...
# -----------------------------
fig.suptitle(
    r"Example realisation: $f(R)$ gravity, $f_{R0}= 10^{-4}$, $\it{Planck}$ $\Omega_{\rm M}^0$ prior, LSST Y10 sources. GR rejected.",
    fontsize=27
)

plt.tight_layout(rect=[0, 0, 1, 0.93])
plt.savefig("../plots/eg_3panel_fr-4_LSSTY10_CMB_simscov.pdf")
plt.show()
